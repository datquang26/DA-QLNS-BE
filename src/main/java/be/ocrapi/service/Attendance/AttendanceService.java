...
//    }
    ...
    @Override
    public ListAttendanceResponse findAndCount(int offset, int page_size,
                                               String from_date,
                                               String to_date,
                                               String status,
                                               String user_id,
        ...
        List<TimeAttendance> results = repository.getList(from_date, to_date, type, user_id, status, offset, page_size);
        Long total = repository.totalFilter(from_date, to_date, type, user_id, status);
        ListAttendanceResponse dataListResponse = new ListAttendanceResponse();
        dataListResponse.setTotal(total);
